...
class States extends Component {
  ...
  render() {
    ...
    let result = (
      <>
        <Jumbotron
          title={"Learn More About Poverty by State in the U.S."}
          description={"Facts and figures of poverty in all 50 states"}
          modelName={"states"}
        />
            ...
            <div className="col-sm-3 d-flex flex-column">
              {prompt && (
                <NativeSelects
                  ...
                  prompt={"Filter by Poverty Rates"}
                  onChange={this.handleFilterBelowPoverty}
                />
              )}
            </div>
            ...
            <div className="col-sm-3 d-flex flex-column">
              {prompt && (
                <NativeSelects
                  ...
                  prompt={"Filter by Median Incomes"}
                  onChange={this.handleFilterMedianIncome}
                />
              )}
            </div>
            <div className="col-sm-3 d-flex flex-column">
              {prompt && (
                <NativeSelects
                  ...
                  prompt={"Filter by Child Poverty Rates"}
                  onChange={this.handleFilterChildPoverty}
                />
              )}
            </div>
