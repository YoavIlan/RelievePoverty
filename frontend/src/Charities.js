      ...
      <>
        ...
        <div className="container-fluid fss">
          <div className="row fss-bar">
            ...
            <div
              className="col-sm-2 d-flex flex-column"
              style={{ marginRight: "8.4%" }}
            >
              {prompt && (
                <NativeSelects
                  reset={this.state.reset}
                  ...
                  onChange={this.handleFilterCause}
                />
              )}
            </div>
            ...
            <div className="col-sm-3 d-flex flex-column">
              {prompt && (
                <NativeSelects
                  ...
                  onChange={this.handleFilterRating}
                />
              )}
            </div>
          ...
          <div className="row fss-bar">
            ...
            <div className="col-sm-3 d-flex flex-column">
              {prompt && (
                <NativeSelects
                  reset={this.state.reset}
                  data={["Independent", "Central", "Subordinate"]}
                  prompt={"Filter by Affiliation"}
                  onChange={this.handleFilterAffiliation}
                />
              )}
            </div>
            <div className="col-sm-3 d-flex flex-column">
          ...
          <div className="container">
            <div className="row">
              {this.state.data.map(obj => (
                <CharitiesCard
                  query={
                    this.state.query.length === undefined
                      ? "q= "
                      : this.state.query
                  }
                  mission={obj.mission}
