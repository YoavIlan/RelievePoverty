        ...
        <div className="card mb-4 box-shadow">
          ...
          <div className="card-body d-flex flex-column">
            <h5 className="card-title">
              <Highlighter searchWords={query} textToHighlight={state} />{" "}
            </h5>
            <div className="card-text">
              <b>Ranking</b>
              <p>
                {rank}
                {getRank(rank)} out of 50 states for its poverty rate
              </p>
              ...
              <p>
                <Highlighter searchWords={query} textToHighlight={counties} />
              </p>
            </div>
            <Link to={`/states/${state}`} className="btn btn-primary mt-auto">
              More Information
            </Link>
          </div>
        </div>
