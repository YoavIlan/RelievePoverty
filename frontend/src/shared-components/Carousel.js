      ...
      <div>
        <Carousel showThumbs={false} showStatus={false}>
          <div style={usMap}>
            <iframe
              title="map"
              src="https://createaclickablemap.com/map.php?&id=75691&maplocation=false&online=true"
              height="100%"
              width="100%"
            />
            <p className="legend">
              <Link to="/states">
                Learn more about poverty in the different states
              </Link>
            </p>
          </div>
          <div>
          ...
          <div>
            <Link to="/news">
              <img
                className="d-block w-100"
                src={require("./../img/News.jpeg")}
                alt="Third slide"
              />
            </Link>
            <p className="legend">
              <Link to="/news">
                News articles related to poverty and charities
              </Link>
            </p>
          </div>
        </Carousel>
