...
class About extends Component {
    ...
    return (
      <>
        <Jumbotron
          ...
          description={
            "Our mission is to educate citizens of the United States about the issues concerning poverty within the country by providing articles and information about it in each state. We then provide information about charities that readers can donate to in order to help fight against poverty. An interesting result of integrating articles, charities, and state statistics concerning poverty is that we were able to make a connection between them even though they were previously three distinct mediums."
          }
        />
        <main role="main">
            ...
            <div className="container">
              <div className="card mb-4 box-shadow">
                <div className="card-body">
                  <h4
                    className="card-title about-card-title"
                ...
                <ul className="list-group list-group-flush">
                  <li className="list-group-item">
                    Total # of commits: {this.state.total.commits}
                  </li>
                  <li className="list-group-item">
                    Total # of issues: {this.state.total.issues}
                  </li>
                  <li className="list-group-item">
                    Total # of unit tests: {this.state.total.tests}
                  </li>
                  <li className="list-group-item">
                    Total # of acceptance tests:{" "}
                    {this.state.total.acceptance_tests}
                  </li>
                </ul>
              </div>
              <div className="row">
              ...
              <div className="card mb-4 box-shadow">
                ...
                <ul className="list-group list-group-flush">
                  <li className="list-group-item">
                    <a
                      href="https://www.census.gov/programs-surveys/saipe/data/api.html"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      US Census Bureau (State Poverty)
                    </a>{" "}
                    - Used The US Census Bureau''s restful SAIPE API to find
                    information on poverty rates by state{" "}
                  </li>
                  <li className="list-group-item">
                    <a
                  ...
                  <li className="list-group-item">
                    ...
                    - Scraped by using their API by searching for poverty
                    related charities
                  </li>
                  <li className="list-group-item">
                    <a
                    ...
                    - Used the API on clearbit to retrieve images from charity
                    websites
                  </li>
                  <li className="list-group-item">
                    <a
                      href="http://www.theus50.com/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      The US50
                    </a>{" "}
                    - Retrieved images of all 50 state flags from URL of this
                    website
                  </li>
                  <li className="list-group-item">
                    <a
                      href="https://createaclickablemap.com/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Create a Clickable Map
                    </a>{" "}
                    - Placed a clickable US map on the home page of this wesite
                  </li>
                  <li className="list-group-item">
                    <a
                    ...
                    - Used to place maps in instance pages
                  </li>
                </ul>
              </div>
              <div className="card mb-4 box-shadow">
                ...
                <ul className="list-group list-group-flush">
                  <li className="list-group-item">
                    ...
                    - Used for version control, continuous integration, and
                  ...
                  <li className="list-group-item">
                    ...
                    - Used for API design and unit testing
                  </li>
                  <li className="list-group-item">
                    <a
                    ...
                    - Used to host our webapp, backend, and database.
                  </li>
                  <li className="list-group-item">
                    <a
                    ...
                    - An open source toolkit for CSS elements.
                  </li>
                  <li className="list-group-item">
                    <a
                    ...
                    - ReactJS is our front-end JavaScript framework. It focuses
                    on components makes it easier for distributed, collaborative
                    work. It also renders out site from API data.
                  </li>
                  <li className="list-group-item">
                    <a
                  ...
                  <li className="list-group-item">
                    ...
                    - Selenium is a framework that allows browser navigation
                    automation.
                  </li>
                  <li className="list-group-item">
                    <a
                      href="https://docs.python.org/2/library/unittest.html"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Unittest
                    </a>{" "}
                    - Python framework that allows creation of unit tests.
                  </li>
                  <li className="list-group-item">
                    <a
                    ...
                    - Program that allows you to see relationship between
  ...
  getIssues() {
    ...
    this.state.team.map(member =>
      urls.push(
        "https://gitlab.com/api/v4/projects/8594442/issues?author_id=" +
          member.issue_id +
          "&per_page=100"
      )
    );
  ...
  getTests() {
    ...
    var urls = [
      "https://gitlab.com/urielkugelmass/relievepoverty/raw/development/Postman.json",
    ...
    var promises = urls.map(url =>
      fetch(proxy + url).then(resp => resp.text())
    );
    var responses = new Array(urls.length);
    Promise.all(promises)
      .then(responses => {
  ...
  getAcceptanceTests() {
    var proxy = "https://cors-anywhere.herokuapp.com/";
    var urls = [
      "https://gitlab.com/urielkugelmass/relievepoverty/raw/development/tst/e2e/test.py"
    ];
    var promises = urls.map(url =>
      fetch(proxy + url).then(resp => resp.text())
    );
